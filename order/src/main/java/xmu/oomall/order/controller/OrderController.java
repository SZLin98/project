package xmu.oomall.order.controller;
...
import xmu.oomall.order.domain.otherdomin.User;
import xmu.oomall.order.domain.vo.OrderSubmitVo;
import xmu.oomall.order.service.OrderService;
import xmu.oomall.order.util.GetUser;

...
public class ResponseUtil {
    ...
    public static Object ok(Object data) {
        Map<String, Object> obj = new HashMap<String, Object>(58);
        obj.put("errno", 0);
        obj.put("errmsg", "成功");
        obj.put("data", data);
        return obj;
    ...
    public static Object fail() {
        Map<String, Object> obj = new HashMap<String, Object>(444);
        obj.put("errno", -1);
            obj.put("errmsg", "错误");
        return obj;
    }
    ...
    public static Object fail(int errno, String errmsg) {
        Map<String, Object> obj = new HashMap<String, Object>(111);
        obj.put("errno", errno);
        obj.put("errmsg", errmsg);
        return obj;
    }

    public static Object badDelete() { return fail(694, "删除售后服务失败");
    }

    public static Object badSelect() {
        return fail(691, "获取售后服务失败");
    }

    public static Object badUpdate() { return fail(693, "修改售后服务失败"); }

    public static Object serious() {
        return fail(502, "系统内部错误");
    }

        public static Object badInsert() { return fail(692, "申请售后服务失败"); }
